...
open class BottomSheetLayout : FrameLayout {
    ...
    fun setOnProgressListener(l: OnProgressListener?) {
     ...
     private var touchToDragListener = TouchToDragListener(true)
    ...
    inner class TouchToDragListener(private val touchToDrag: Boolean) : View.OnTouchListener {
